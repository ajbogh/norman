...
function startMicInstance() {
  ...
  outputFileStream = fs.WriteStream(`${path.resolve(__dirname)}/../resources/output.raw`);
...
function bindListeners(micInputStream, micInstance, outputFileStream){
  ...
  micInputStream.on('silence', function() {
    ...
    // const forked = fork('lib/recognizer.js');
    // forked.on('message', (msg) => {
    //   console.log('Message from child', msg);
    // });

    // forked.send({ recognize });
