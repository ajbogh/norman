...
if (!fs.existsSync('./resources/output.wav')) {
  throw "No output.wav file found! Run listener first.";
}

// run process for pocketsphinx_continuous
const command = `./node_modules/pocketsphinx/bin/pocketsphinx_continuous -infile ./resources/output.wav -lm ./resources/corpus/${prefix}.lm -dict ./resources/corpus/${prefix}.dic`;
