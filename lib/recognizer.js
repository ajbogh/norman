...
const keywords = reload('./commands').readKeywords();
var debug = require('debug')('norman-recognizer');
...
function searchForMatches(recognizedWordsArray, lastMatchTime) {
  ...
  // if no key was matched, ignore this and return
  if(!argv.debug && !response.matchedKey){
    return null;
  }
